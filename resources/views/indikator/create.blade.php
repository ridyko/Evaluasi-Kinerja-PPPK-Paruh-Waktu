...
<div class="page-header">
    <div>
        ...
        <p>Tambah indikator kinerja individu baru</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('indikator.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="nomor_urut" class="form-control" value="{{ old('nomor_urut', 1) }}" required min="1" style="max-width: 120px;">
            </div>
            <div class="form-group">
                <label class="form-label">Deskripsi Indikator <span style="color: var(--danger);">*</span></label>
                <textarea name="deskripsi" class="form-control" rows="4" required placeholder="Jumlah rekapitulasi ...">{{ old('deskripsi') }}</textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Target Tahunan <span style="color: var(--danger);">*</span></label>
                <input type="text" name="target_tahunan" class="form-control" value="{{ old('target_tahunan', '12 Rekapitulasi') }}" required style="max-width: 300px;">
            </div>
