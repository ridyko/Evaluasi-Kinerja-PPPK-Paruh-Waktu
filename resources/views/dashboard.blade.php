...
<div class="grid-2">
    ...
    <div>
        @if(!auth()->user()->isPegawai())
        {{-- WhatsApp Notifications History (Replaced Chart) --}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size: 0.7rem; color: var(--text-secondary);">{{ $log->phone }}</div>
                                </td>
                                <td>
                                    @if($log->status === 'sent')
        ...
        @else
        {{-- For Pegawai, Keep Chart or something else --}}
        <div class="card">
            <div class="card-header">
            ...
            <div class="card-body">
                <div style="display: flex; align-items: flex-end; gap: 6px; height: 200px; padding-top: 1rem;">
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 4px;">
                        ...
                        <div style="width: 100%; height: {{ $maxVal > 0 ? ($val / $maxVal * 160) : 0 }}px; min-height: 4px; background: linear-gradient(180deg, var(--primary), var(--accent)); border-radius: 4px 4px 0 0;"></div>
                            ...
                            <tr>
                                ...
                                @else
                                    <td>
                                        ...
                                        <div style="font-size: 0.7rem; color: var(--text-secondary);">{{ $ev->nama_bulan }} {{ $ev->tahun }}</div>
                                    </td>
                                @endif
                                <td>
